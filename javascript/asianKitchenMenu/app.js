...
const cateButton = buttons.map((button) => `<button id="${button.id}">${button.text}</button>`).join("");

const btnContainer = document.querySelector(".btn-container");

btnContainer.innerHTML = cateButton;
...
sectionDOM.innerHTML = foodItems;
...
btnContainer.addEventListener("click", (e) =>
{
  if (e.target.tagName === "BUTTON") 
  {
    ...
    const filteredItemsHTML = filteredItems
      ...
      .join("");
    sectionDOM.innerHTML = filteredItemsHTML;
